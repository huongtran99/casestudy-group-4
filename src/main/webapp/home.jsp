...
<div class="header_bg">
    <div class="container">
        <div class="header">
            <div class="head-t">
                <div class="logo">
                    <a href="home.jsp"><img src="images/logo3h1s.jpg" class="img-responsive" width="300" height="60" alt=""/> </a>
                </div>
                <!-- start header_right -->
                <div class="header_right">
                    <div class="rgt-bottom">
                        ...
                        <div class="reg">
                            <a href="/" style="font-family: bold; margin-left: 10px"><h4>Logout</h4></a>
                        </div>
                        ...
                        <div class="create_btn">
                            <a href="/order"  style="background-color: yellowgreen">CHECKOUT</a>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
    ...
    <div class="container">
        <div class="arriv-top">
            ...
            <div class="col-md-6 arriv-right">
                ...
                <div class="arriv-info" style="color: #45BF55">
                    <h3>BOOK</h3>
                    <p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
                    <div class="crt-btn">
        ...
        <div class="arriv-bottm">
            <div class="col-md-8 arriv-left1">
                ...
                <div class="arriv-info1" style="color: #45BF55">
                    <h3>WATER BOTTLE</h3>
                    <p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
                    <div class="crt-btn">
                        <a href="details.html" style="color: yellow">SHOP NOW</a>
            ...
            <div class="col-md-4 arriv-right1">
                ...
                <div class="arriv-info2" style="color: red">
