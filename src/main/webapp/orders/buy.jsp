    ...
    <div class="check">
        <div class="col-md-3 cart-total">
            ...
            <ul class="total_price">
                ...
                <li class="last_price"><span>${orderDetails.price}</span></li>
                <div class="clearfix"></div>
            </ul>
            <div class="clearfix"></div>
            <form action="/order?action=order" method="post">
                <input type="hidden" name="id" value="${orderDetails.order_detail_id}">
                ...
                <div class="cart-header">
                    <div class="cart-sec simpleCart_shelfItem">
                        <div class="cart-item cyc">
                            <img src="${orderDetails.product.product_image}" class="img-responsive" alt="ava">
                        </div>
